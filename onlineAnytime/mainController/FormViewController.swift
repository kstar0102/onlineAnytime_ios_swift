...
//        print(strBase64)
    ...
    func MoneyLint(title:String, id:String, position:Int, beforetype:String, beposition:Int) {
        ...
        sentfield.tag = dollerid + 1000
        moneytag2 = dollerid + 1000
